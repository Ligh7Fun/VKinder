...
Функциональность
Поиск пользователей ВКонтакте по городу, полу и возрасту.
Добавление пользователей в избранные через лайки.
Управление списком избранных пользователей через дизлайки.
